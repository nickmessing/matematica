...
const { Component: ABLine } = useLine(() => ({
  ...
  lineClass: selectedElementId.value === 'ab-segment' ? 'svg-node-focused' : 'svg-node-transparent',
}))
const { Component: CDLine } = useLine(() => ({
  ...
  lineClass: selectedElementId.value === 'cd-segment' ? 'svg-node-focused' : 'svg-node-transparent',
}))
...
const { Component: BCLine } = useLine(() => ({
  ...
  lineClass: selectedElementId.value === 'bc-segment' ? 'svg-node-focused' : 'svg-node-transparent',
}))
